...
- **Nix** declares nixpkgs, Home Manager, nix-darwin, and
...
How local clients receive those instructions, coordinate work through their
native tools, and preserve application-owned state is documented in
